...
exports.default = (function (_a, config) {
    ...
    var corePath = "../db-subscribers/*.js";
    ...
    core.forEach(function (fn) {
        ...
        Object.entries(loaded).map(function (_a) {
            ...
            if (typeof val === "function" || val instanceof typeorm_1.EventSubscriber) {
                if (config.register) {
                    var name = (0, format_registration_name_1.default)(fn);
                    container.register((_b = {},
                        _b[name] = (0, awilix_1.asClass)(val),
                        _b));
                    container.registerAdd("db_subscribers", (0, awilix_1.asValue)(val));
                }
                toReturn.push(val);
            }
        });
...
//# sourceMappingURL=db-subscribers.js.map