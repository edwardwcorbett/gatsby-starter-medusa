...
var tax_calculation_strategy_1 = require("../interfaces/tax-calculation-strategy");
...
function registerStrategies(pluginDetails, container) {
    var module;
    try {
        var path_2 = "".concat(pluginDetails.resolve, "/strategies/tax-calculation");
        if ((0, fs_exists_cached_1.sync)(path_2)) {
            module = require(path_2).default;
        }
        else {
            return;
        }
    ...
    if ((0, tax_calculation_strategy_1.isTaxCalculationStrategy)(module.prototype)) {
        container.register({
        ...
        logger.warn("".concat(pluginDetails.resolve, "/strategies/tax-calculation did not export a class that implements ITaxCalculationStrategy. Your Medusa server will still work, but if you have written custom tax calculation logic it will not be used. Make sure to implement the ITaxCalculationStrategy interface."));
    }
}
