...
var OrderService = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(raw.map(function (r) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.decorateTotals_(r, totalsToSelect)];
    ...
    OrderService.prototype.retrieve = function (orderId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var orderRepo, validatedId, _a, select, relations, totalsToSelect, query, rels, raw;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        orderRepo = this.manager_.getCustomRepository(this.orderRepository_);
    ...
    OrderService.prototype.decorateTotals_ = function (order, totalsFields) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var totalsFields_1, totalsFields_1_1, totalField, _a, _b, _c, paid_total, refunded_total, _d, _e, s, _f, _g, c, e_16_1;
            var e_16, _h, e_17, _j, e_18, _k;
            var _this = this;
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        _l.trys.push([0, 19, 20, 21]);
                        totalsFields_1 = __values(totalsFields), totalsFields_1_1 = totalsFields_1.next();
                        _l.label = 1;
                    case 1:
                        if (!!totalsFields_1_1.done) return [3 /*break*/, 18];
                        totalField = totalsFields_1_1.value;
                        _a = totalField;
                        switch (_a) {
                            case "shipping_total": return [3 /*break*/, 2];
                            case "gift_card_total": return [3 /*break*/, 3];
                            case "discount_total": return [3 /*break*/, 4];
                            case "tax_total": return [3 /*break*/, 5];
                            case "subtotal": return [3 /*break*/, 7];
                            case "total": return [3 /*break*/, 8];
                            case "refunded_total": return [3 /*break*/, 10];
                            case "paid_total": return [3 /*break*/, 11];
                            case "refundable_amount": return [3 /*break*/, 12];
                            case "items.refundable": return [3 /*break*/, 13];
                            case "swaps.additional_items.refundable": return [3 /*break*/, 14];
                            case "claims.additional_items.refundable": return [3 /*break*/, 15];
                        }
                        return [3 /*break*/, 16];
                    case 2:
                        {
                    ...
                    case 8:
                        _c = order;
                        return [4 /*yield*/, this.totalsService_.getTotal(order)];
                    case 9:
                        _c.total = _l.sent();
                        return [3 /*break*/, 17];
                    case 10:
                    ...
                    case 14:
                        {
                            try {
                                for (_d = (e_17 = void 0, __values(order.swaps)), _e = _d.next(); !_e.done; _e = _d.next()) {
                                    s = _e.value;
                    ...
                    case 15:
                        {
                            try {
                                for (_f = (e_18 = void 0, __values(order.claims)), _g = _f.next(); !_g.done; _g = _f.next()) {
                                    c = _g.value;
                    ...
                    case 20:
                        try {
                            if (totalsFields_1_1 && !totalsFields_1_1.done && (_h = totalsFields_1.return)) _h.call(totalsFields_1);
                        }
