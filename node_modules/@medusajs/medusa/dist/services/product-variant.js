...
var ProductVariantService = /** @class */ (function (_super) {
    ...
    ProductVariantService.prototype.update = function (variantOrVariantId, update) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var variantRepo, variant, prices, options, metadata, inventory_quantity, rest, options_1, options_1_1, option, e_2_1, _a, _b, _c, key, value, result;
                        var e_2, _d, e_3, _e;
    ...
    ProductVariantService.prototype.updateVariantPrices = function (variantId, prices) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var moneyAmountRepo, obsoletePrices, prices_2, prices_2_1, price, e_4_1;
                        var e_4, _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                ...
                                case 2:
                                    ...
                                    _b.label = 3;
                                case 3:
                                    if (!!prices_2_1.done) return [3 /*break*/, 8];
                                    price = prices_2_1.value;
                                    if (!price.region_id) return [3 /*break*/, 5];
                                ...
                                case 4:
                                    _b.sent();
                                    return [3 /*break*/, 7];
                                case 5: return [4 /*yield*/, this.setCurrencyPrice(variantId, price)];
                                case 6:
                                    _b.sent();
                                    _b.label = 7;
                                case 7:
                                ...
                                case 10:
                                    ...
                                    return [7 /*endfinally*/];
                                case 11: return [4 /*yield*/, moneyAmountRepo.remove(obsoletePrices)];
                                case 12:
                                    _b.sent();
                                    return [2 /*return*/];
                            }
                ...
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    moneyAmountRepo = manager.getCustomRepository(this.moneyAmountRepository_);
                                    return [4 /*yield*/, moneyAmountRepo.upsertCurrencyPrice(variantId, price)];
    ...
    ProductVariantService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var variantRepo, _b, q, query, relations, qb, _c, raw, count, variants;
