...
var LineItemService = /** @class */ (function (_super) {
    ...
    function LineItemService(_a) {
        var manager = _a.manager, lineItemRepository = _a.lineItemRepository, lineItemTaxLineRepository = _a.lineItemTaxLineRepository, productVariantService = _a.productVariantService, productService = _a.productService, regionService = _a.regionService, cartRepository = _a.cartRepository;
    ...
    LineItemService.prototype.createReturnLines = function (returnId, cartId) {
        return __awaiter(this, void 0, void 0, function () {
            var lineItemRepo, itemTaxLineRepo, items, toCreate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        lineItemRepo = this.manager_.getCustomRepository(this.lineItemRepository_);
                        itemTaxLineRepo = this.manager_.getCustomRepository(this.itemTaxLineRepo_);
                        return [4 /*yield*/, lineItemRepo.findByReturn(returnId)];
                    case 1:
                        items = _a.sent();
                        toCreate = items.map(function (i) {
                            return lineItemRepo.create({
                                ...
                                tax_lines: i.tax_lines.map(function (tl) {
                        ...
                        return [4 /*yield*/, lineItemRepo.save(toCreate)];
