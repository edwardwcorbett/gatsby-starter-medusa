...
declare class ReturnService extends ReturnService_base {
    [x: string]: any;
    constructor({ manager, totalsService, lineItemService, returnRepository, returnItemRepository, shippingOptionService, returnReasonService, taxProviderService, fulfillmentProviderService, inventoryService, orderService, }: {
        manager: any;
        totalsService: any;
        lineItemService: any;
