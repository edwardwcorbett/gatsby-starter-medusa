...
import { SubtotalOptions, LineDiscount, LineAllocationsMap, LineDiscountAmount } from "../types/totals";
 ...
 */
declare class TotalsService extends BaseService {
    private taxProviderService_;
    private taxCalculationStrategy_;
    constructor({ taxProviderService, taxCalculationStrategy, }: TotalsServiceProps);
    /**
