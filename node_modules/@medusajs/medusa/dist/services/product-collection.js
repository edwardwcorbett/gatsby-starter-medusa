...
var ProductCollectionService = /** @class */ (function (_super) {
    ...
    ProductCollectionService.prototype.withTransaction = function (transactionManager) {
        if (!transactionManager) {
            return this;
        }
        var cloned = new ProductCollectionService({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        collectionRepo = this.manager_.getCustomRepository(this.productCollectionRepository_);
                        query = this.buildQuery_({ handle: collectionHandle }, config);
                        return [4 /*yield*/, collectionRepo.findOne(query)];
                    case 1:
                        collection = _a.sent();
                        if (!collection) {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            return [2 /*return*/, collectionRepo.save(productCollection)];
                        });
                    }); })];
            });
        });
