...
declare class RegionService extends RegionService_base {
    ...
    constructor({ manager, regionRepository, countryRepository, storeService, eventBusService, currencyRepository, paymentProviderRepository, fulfillmentProviderRepository, taxProviderRepository, paymentProviderService, fulfillmentProviderService, }: {
        manager: any;
    ...
    private taxProviderRepository_;
