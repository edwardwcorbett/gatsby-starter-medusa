...
var CustomerService = /** @class */ (function (_super) {
    ...
    function CustomerService(_a) {
        var manager = _a.manager, customerRepository = _a.customerRepository, eventBusService = _a.eventBusService, addressRepository = _a.addressRepository, customerGroupService = _a.customerGroupService;
    ...
    CustomerService.prototype.validateEmail_ = function (email) {
        var schema = medusa_core_utils_1.Validator.string()
            .email()
            .required();
    ...
    CustomerService.prototype.update = function (customerId, update) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var customerRepository, addrRepo, customer, email, password, metadata, billing_address, billing_address_id, groups, rest, address, _a, _b, _c, key, value, _d, id, _e, updated;
                        var e_1, _f;
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                ...
                                case 1:
                                    customer = _g.sent();
                                    email = update.email, password = update.password, metadata = update.metadata, billing_address = update.billing_address, billing_address_id = update.billing_address_id, groups = update.groups, rest = __rest(update, ["email", "password", "metadata", "billing_address", "billing_address_id", "groups"]);
                                    if (metadata) {
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, this.hashPassword_(password)];
                                case 4:
                                    _d.password_hash = _g.sent();
                                    _g.label = 5;
                                case 5:
                                    if (!groups) return [3 /*break*/, 7];
                                    id = groups.map(function (g) { return g.id; });
                                    _e = customer;
                                    return [4 /*yield*/, this.customerGroupService_.list({ id: id })];
                                case 6:
                                    _e.groups = _g.sent();
                                    _g.label = 7;
                                case 7: return [4 /*yield*/, customerRepository.save(customer)];
                                case 8:
                                    updated = _g.sent();
                                    return [4 /*yield*/, this.eventBus_
                                            .withTransaction(manager)
