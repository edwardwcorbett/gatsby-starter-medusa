...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validated, customerGroupService, expandFields, findConfig, customerGroup;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, validator_1.validator)(AdminGetCustomerGroupsGroupParams, req.query)];
            case 1:
                validated = _a.sent();
