...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validated, productCollectionService, collection;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, validator_1.validator)(AdminPostProductsToCollectionReq, req.body)];
            case 1:
                validated = _a.sent();
                productCollectionService = req.scope.resolve("productCollectionService");
                return [4 /*yield*/, productCollectionService.addProducts(id, validated.product_ids)];
            case 2:
                collection = _a.sent();
