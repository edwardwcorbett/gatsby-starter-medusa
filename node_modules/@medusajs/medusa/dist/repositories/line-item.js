...
var LineItemRepository = /** @class */ (function (_super) {
    __extends(LineItemRepository, _super);
    function LineItemRepository() {
     ...
     */
    LineItemRepository.prototype.findByReturn = function (returnId) {
    ...
    LineItemRepository = __decorate([
        (0, typeorm_1.EntityRepository)(line_item_1.LineItem)
    ], LineItemRepository);
    return LineItemRepository;
}(typeorm_1.Repository));
exports.LineItemRepository = LineItemRepository;
