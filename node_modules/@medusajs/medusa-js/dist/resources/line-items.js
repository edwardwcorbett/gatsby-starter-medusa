...
var LineItemsResource = /** @class */ (function (_super) {
     ...
     */
    LineItemsResource.prototype.create = function (cart_id, payload, customHeaders) {
     ...
     * @return {ResponsePromise<StoreCartsRes>}
     */
    LineItemsResource.prototype.update = function (cart_id, line_id, payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
     ...
     * @return {ResponsePromise<StoreCartsRes>}
     */
    LineItemsResource.prototype.delete = function (cart_id, line_id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/carts/" + cart_id + "/line-items/" + line_id;
