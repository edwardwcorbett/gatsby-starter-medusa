...
var ProductVariantsResource = /** @class */ (function (_super) {
    __extends(ProductVariantsResource, _super);
    function ProductVariantsResource() {
     ...
     */
    ProductVariantsResource.prototype.retrieve = function (id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/variants/" + id;
     ...
     */
    ProductVariantsResource.prototype.list = function (query, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/variants";
        if (query) {
...
exports.default = ProductVariantsResource;
