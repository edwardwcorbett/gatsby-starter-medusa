...
var GiftCardsResource = /** @class */ (function (_super) {
    __extends(GiftCardsResource, _super);
     ...
     */
    GiftCardsResource.prototype.retrieve = function (code, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/gift-cards/" + code;
