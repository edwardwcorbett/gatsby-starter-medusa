...
var ReturnsResource = /** @class */ (function (_super) {
    __extends(ReturnsResource, _super);
     ...
     */
    ReturnsResource.prototype.create = function (payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/returns";
        return this.client.request("POST", path, payload, {}, customHeaders);
    };
    return ReturnsResource;
}(base_1.default));
exports.default = ReturnsResource;
