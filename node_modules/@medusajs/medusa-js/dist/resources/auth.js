...
var AuthResource = /** @class */ (function (_super) {
    __extends(AuthResource, _super);
     ...
     */
    AuthResource.prototype.authenticate = function (payload, customHeaders) {
     ...
     * @return {ResponsePromise<StoreAuthRes>}
     */
    AuthResource.prototype.getSession = function (customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/auth";
     ...
     */
    AuthResource.prototype.exists = function (email, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/store/auth/" + email;
        return this.client.request("GET", path, {}, {}, customHeaders);
    };
    return AuthResource;
}(base_1.default));
