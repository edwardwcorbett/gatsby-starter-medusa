...
var AdminUsersResource = /** @class */ (function (_super) {
     ...
     * @returns
     */
    AdminUsersResource.prototype.sendResetPasswordToken = function (payload, customHeaders) {
     ...
     * @returns
     */
    AdminUsersResource.prototype.resetPassword = function (payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
     ...
     * @returns the user
     */
    AdminUsersResource.prototype.retrieve = function (id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
     ...
     */
    AdminUsersResource.prototype.create = function (payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
     ...
     */
    AdminUsersResource.prototype.update = function (id, payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/users/" + id;
        return this.client.request("POST", path, payload, {}, customHeaders);
    };
     ...
     */
    AdminUsersResource.prototype.delete = function (id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/users/" + id;
     ...
     */
    AdminUsersResource.prototype.list = function (customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/users";
        return this.client.request("GET", path, {}, {}, customHeaders);
    };
