...
var AdminShippingOptionsResource = /** @class */ (function (_super) {
     ...
     */
    AdminShippingOptionsResource.prototype.create = function (payload, customHeaders) {
     ...
     */
    AdminShippingOptionsResource.prototype.update = function (id, payload, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
     ...
     */
    AdminShippingOptionsResource.prototype.delete = function (id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/shipping-options/" + id;
     ...
     */
    AdminShippingOptionsResource.prototype.retrieve = function (id, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/shipping-options/" + id;
     ...
     */
    AdminShippingOptionsResource.prototype.list = function (query, customHeaders) {
        if (customHeaders === void 0) { customHeaders = {}; }
        var path = "/admin/shipping-options";
        if (query) {
